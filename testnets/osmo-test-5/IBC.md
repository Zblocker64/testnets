...
| `osmo-test-5` | `sandbox-2`               | `channel-11412` | `channel-0`    | Akash testnet       |
...
| AKASH       | `akt`      | `ibc/341A56584979D345975EADDE8D3739E96F69D50DA1D7D5797BB070CEAADC3678` |
...
| AXELAR-USDC | `ausdc`    | `ibc/F4716C8ACAB365F3B3DD7FDB1D1B697819A03AB867BAB1469B655B188650668B` |
...
| Akash       | `sandbox`                 | <https://faucet.sandbox-2.aksh.pw/>                                                      |
...
| Akash       | `sandbox-01`              | <https://rpc.sandbox-2.aksh.pw:443>                    | <https://api.sandbox-2.aksh.pw/>                    |
...
| Akash       | `sandbox-2`               | <https://github.com/akash-network/net/tree/master/sandbox>                         |
